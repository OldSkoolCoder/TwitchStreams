...
SpritesY:
    .fill 8, RasterBand1 + 5
    .fill 8, RasterBand2 + 5
    .fill 8, RasterBand3 + 5
    .fill 8, RasterBand4 + 5
    .fill 8, RasterBand5 + 5
    .fill 8, RasterBand6 + 5
    .fill 8, RasterBand7 + 5
