...
.label JumpAnimationLeftMCLen = [_JumpAnimationLeftMC - JumpAnimationLeftMC]
.label JumpAnimationRightMCLen = [_JumpAnimationRightMC - JumpAnimationRightMC]
...
.label JumpAnimationLeftHRLen = [_JumpAnimationLeftHR - JumpAnimationLeftHR]
.label JumpAnimationRightHRLen = [_JumpAnimationRightHR - JumpAnimationRightHR]
...
.label AnimateQuazzyLeftMCLen = [_AnimateQuazzyLeftMC - AnimateQuazzyLeftMC]
.label AnimateQuazzyRightMCLen = [_AnimateQuazzyRightMC - AnimateQuazzyRightMC]
...
.label AnimateQuazzyLeftHRLen = [_AnimateQuazzyLeftHR - AnimateQuazzyLeftHR]
.label AnimateQuazzyRightHRLen = [_AnimateQuazzyRightHR - AnimateQuazzyRightHR]

AnimateEsmeraldaMC:
    .byte 202, 203, 204, 205
_AnimateEsmeraldaMC:

.label AnimateEsmeraldaMCLen = [_AnimateEsmeraldaMC - AnimateEsmeraldaMC]

AnimateEsmeraldaHR:
    .byte 210, 211, 212, 213
_AnimateEsmeraldaHR:

.label AnimateEsmeraldaHRLen = [_AnimateEsmeraldaHR - AnimateEsmeraldaHR]
