...
start:
    ...
    ldy #0
    lda #1
    jsr libSprites.SetEnable            // Enable Sprite 0

    iny
    lda #1
    jsr libSprites.SetEnable            // Enable Sprite 1

    iny
    lda #1
    jsr libSprites.SetEnable            // Enable Sprite 2

    iny
    lda #1
    jsr libSprites.SetEnable            // Enable Sprite 3
